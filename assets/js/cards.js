...
$(document).ready(function(){
  ...
  $(document).on( "click","#insertKanji", function() {
    insertKanji();
  });
...
$(document).on("keyup", "#newKanjiJapanese", function() {
    var car = $("#newKanjiJapanese").val(), x = car[car.length - 1];
...
function insertKanji() {
  var english = $("#newKanjiEnglish").val(),
  japanese = $("#newKanjiJapanese").val(),
  examples = $("#newKanjiExamples").val(),
  still = $("#newKanjiStill").val(),
  tags = $("#newKanjiTags").val();
  $.post("kanji/insert", {
    english: english,
    japanese: japanese,
    examples: examples,
